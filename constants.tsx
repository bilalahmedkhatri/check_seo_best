...
export const NAV_ITEMS: NavItem[] = [
  {
    ...
    description: 'Discover high-value keywords to target for your content.'
  },
  {
    key: 'serpMonitoring',
    label: 'SERP Monitoring',
    icon: <ChartBarIcon />,
    title: 'SERP Monitoring',
    description: 'Analyze search engine results pages and track your competitors.'
  },
  {
    key: 'contentBrief',
    ...
    description: 'Generate comprehensive content briefs in seconds.'
  },
  {
    key: 'onPageOptimizer',
    ...
    description: 'Optimize your content for your target keywords.'
  },
  {
    key: 'keywordStrategist',
    label: 'Keyword Strategist',
    icon: <LightbulbIcon />,
    title: 'AI Keyword Strategist',
    description: 'Develop a comprehensive keyword strategy from seed ideas to content clusters.'
  }
];
